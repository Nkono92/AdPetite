! function (A) {
    function e(e) {
        for (var B, C, I = e[0], Q = e[1], i = e[2], o = 0, a = []; o < I.length; o++) C = I[o], Object.prototype.hasOwnProperty.call(t, C) && t[C] && a.push(t[C][0]), t[C] = 0;
            ...
            return n()(A, [{
                ...
                value: function (A) {
                    if (0 !== A.length) {
                        ...
                        for (var g = 0; g < e; g++) {
                            var B = A[g];
                            B.token = Math.random().toString(36).substring(2, 15) + Math.random().toString(36).substring(2, 15), this.cachedFileArray.push(B), this.processFile(B)
                        }
                ...
                value: function (A) {
                    ...
                    return new Promise(function () {
                        var g = C()(t.a.mark((function g(B, E) {
                            var C, I, Q, i, n;
                            return t.a.wrap((function (g) {
                                for (;;) switch (g.prev = g.next) {
                                    ...
                                    case 11:
                                        ...
                                        break;
                                    case 14:
                                        return g.prev = 14, g.t0 = g.catch(5), E(g.t0), g.abrupt("continue", 21);
                                    case 18:
                                        (n = new Blob([i], {
                                            type: i.type
    ...
    document.querySelector(".upload-info-button--second").addEventListener("click", (function () {
        console.log("Second upload:", r, r.cachedFileArray)
