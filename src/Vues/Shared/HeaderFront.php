    ...
    <div class="container" style="max-width: 1500px !important;">
        <div class="row">
            <div class="col-md-12 col-lg-12 col-xs-12 text-center">
                <div class="contents">
                    <h1 class="head-title">Bienvenu sur <span class="year">PrimoAnnonces</span></h1>
                                ...
                                <div class="form-group inputwithicon">
                                    ...
                                    <div class="select">
                                        <select class="" name="IdSousCategorie" id="IdSousCategorie">
                                            <option selected="selected" disabled="true" >Veuillez sélectionnez une categorie</option>
