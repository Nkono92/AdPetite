<?php $this->titre = "Nouveau mode de paiement"; ?>
...
<section class="section-container">
    ...
    <div class="content-wrapper">
        ...
        <div class="row">
            <div class="col-xl-12">
                <form method="post" data-parsley-validate="" action="ModePaiement/Ajouter" method="post">
                    <!-- START card-->
                    <div class="card card-default">
                        ...
                        <div class="card-body">
                            <div class="form-group row">
                                ...
                                <div class="col-sm-4">
                                    <input class="form-control" id="CodeMode" type="text" placeholder="Veuillez entrer le Code" tabindex="2" name="CodeMode" required>
                                </div>
                            </div>
