<?php $this->titre = "Nouvel administrateur"; ?>
...
<section class="section-container">
    ...
    <div class="content-wrapper">
        ...
        <div class="row">
            <div class="col-xl-12">
                <form method="post" data-parsley-validate="" action="Utilisateur/Ajouter" method="post" enctype="multipart/form-data">
                    <!-- START card-->
                                ...
                                <div class="col-sm-4">
                                    <select class="form-control select2-1" tabindex="10" name="IdProfilUtilisateur" id="IdProfilUtilisateur" required>
                                        ...
                                        <?php /*foreach ($ProfilUtilisateur as $leProfilUtilisateur): ?>
                                            <option value="<?= $this->nettoyer($leProfilUtilisateur->getIdProfilUtilisateur()) ?>">
