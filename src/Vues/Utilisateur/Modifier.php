<?php $this->titre = "Modifier un utilisateur"; ?>
...
<section class="section-container">
    ...
    <div class="content-wrapper">
        ...
        <div class="row">
            <div class="col-xl-12">
                <form method="post" data-parsley-validate="" action="Utilisateur/Modifier" method="post" enctype="multipart/form-data">
                    ...
                    <div class="card card-default">
                        ...
                        <div class="card-body">
                            <div class="form-group row">
                                ...
                                <div class="col-sm-4">
                                    <input class="form-control" id="Nom" type="text" placeholder="Veuillez entrer le nom" tabindex="1" name="Nom" value="<?= $this->nettoyer($Utilisateur->getNom()) ?>"required>
                                </div>

                                <label class="col-sm-2 col-form-label" for="Prenom">Prenom <span class="text-danger">*</span></label>
                                <div class="col-sm-4">
                                    <input class="form-control" id="Prenom" type="text" placeholder="Veuillez entrer le prénom" tabindex="2" name="Prenom" value="<?= $this->nettoyer($Utilisateur->getPrenom()) ?>" required>
                                </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-4">
                                    <input class="form-control" id="Email" type="email" placeholder="Veuillez entrer l'email" tabindex="4" name="Email" value="<?= $this->nettoyer($Utilisateur->getEmail()) ?>" required>
                                </div>
                            </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-4">
                                    <input class="form-control" id="Rue" type="text" placeholder="Veuillez entrer le nom de la rue" tabindex="7" value="<?= $this->nettoyer($Utilisateur->getRue()) ?>" name="Rue">
                                </div>

                                <label class="col-sm-2 col-form-label" for="BoitePostale">Boite postale</label>
                                <div class="col-sm-4">
                                    <input class="form-control" id="BoitePostale" type="text" placeholder="Veuillez entrer la boite postale" tabindex="8" value="<?= $this->nettoyer($Utilisateur->getBoitePostale()) ?>" name="BoitePostale" data-parsley-type="number">
                                </div>
                            </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-4">
                                    <select class="form-control select2-1" tabindex="10" name="IdProfilUtilisateur" id="IdProfilUtilisateur" required>
