<?php $this->titre = "Modifier le type de pièce jointe"; ?>
...
<section class="section-container">
    ...
    <div class="content-wrapper">
        ...
        <div class="row">
            <div class="col-xl-12">
                <form method="post" data-parsley-validate="" action="TypePieceJointe/Modifier" method="post">
                    ...
                    <div class="card card-default">
                        ...
                        <div class="card-body">
                            <div class="form-group row">
                                ...
                                <div class="col-sm-10">
                                    <input class="form-control" id="Libelle" type="text" placeholder="Veuillez entrer le libelle" tabindex="1" value="<?= $this->nettoyer($TypePieceJointe->getLibelle()) ?>" name="Libelle" required>
                                </div>
                            </div>
