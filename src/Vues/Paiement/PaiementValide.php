<?php $this->titre = "PrimoAnnonce - Paiement Confirmé"; ?>
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="breadcrumb-wrapper">
                    <h2 class="product-title">Paiement confirmé</h2>
                    <ol class="breadcrumb">
                        <li><a href="Accueil">Accueil /</a></li>
                        <li class="current">Paiement confirmé</li>
                    </ol>
                </div>
            </div>
        </div>
    ...
    <div class="container" style="max-width: 1300px !important;">
        <div class="row">
            ...
            <div class="col-sm-12 col-md-4 col-lg-5">
                <!-- Main section Start -->
                <!-- Page content-->
                    <img class="" src="Content/img/bgConfirmation.png" alt="Image">
                <!-- Main section End -->
            </div>
            <div class="col-sm-12 col-md-4 col-lg-2"></div>
