<?php $this->titre = "Nouveau département"; ?>
...
<section class="section-container">
    ...
    <div class="content-wrapper">
        ...
        <div class="row">
            <div class="col-xl-12">
                <form method="post" data-parsley-validate="" action="Departement/Ajouter" method="post">
                    <!-- START card-->
                    <div class="card card-default">
                        ...
                        <div class="card-body">
                            <div class="form-group row">
                                ...
                                <div class="col-sm-4">
                                    <select class="form-control select2-1" name="IdPays" id="IdPays" required>
                                        <option selected>Veuillez sélectionner un pays</option>
                                        <?php foreach ($Pays as $lePays): ?>
                                        <option value="<?= $this->nettoyer($lePays->getIdPays()) ?>">
