<?php $this->titre = "Modifier une sous catégorie"; ?>
...
<section class="section-container">
    ...
    <div class="content-wrapper">
        ...
        <div class="row">
            <div class="col-xl-12">
                <form method="post" data-parsley-validate="" action="SousCategorie/Modifier" method="post">
                    ...
                    <div class="card card-default">
                        ...
                        <div class="card-body">
                            <div class="form-group row">
                                ...
                                <div class="col-sm-4">
                                    <input class="form-control"  id="Libelle" type="text" placeholder="Veuillez entrer le libelle" tabindex="1" value="<?= $this->nettoyer($SousCategorie->getLibelle()) ?>" name="Libelle" required>
                                </div>

                                <label class="col-sm-2 col-form-label" for="FontIcone">Font Icone <span class="text-danger">*</span></label>
                                <div class="col-sm-4">
                                    <input class="form-control"  id="FontIcone" type="text" placeholder="Veuillez entrer le FontIcone" tabindex="2" value="<?= $this->nettoyer($SousCategorie->getFontIcone()) ?>" name="FontIcone" required>
                                </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-4">
                                    <select class="form-control select2-1"  id="IdCategorie" name="IdCategorie" required>
