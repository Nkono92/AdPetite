<?php $this->titre = "PrimoAnnonce - Chercher annonces"; ?>
    ...
    <div class="container" style="max-width: 1400px !important;">
        <div class="row">
            ...
            <div class="col-lg-8 col-md-12 col-xs-12 page-content">
                <nav class="nav-table">
                    <ul>
                        <?php foreach ($TableauDeParametres as $param): ?>
                            <li class="active"><a href="javascript:void(0)"><?= $this->nettoyer($param) ?></a></li>
                        <?php endforeach; ?>
                    </ul>
                </nav>
