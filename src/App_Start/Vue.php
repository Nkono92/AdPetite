...
class Vue
{
    ...
    /** Nom du layout à utiliser (défini dans le fichier de vue)  */
    private $layout;
    ...
    public function generer($donnees)
    {
        ...
        // Génération du Layout commun utilisant la partie spécifique
        //$vue = $this->genererFichier('Vues/LayoutFront.php',
        if ($this->layout == null || $this->layout == "")
            $this->layout = ((isset($_SESSION['Layout']) && $_SESSION['Layout'] != "")? $_SESSION["Layout"]: 'LayoutFront.php');

        $vue = $this->genererFichier('Vues/'.$this->layout,
